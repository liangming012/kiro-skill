...
try {
    ...
    Write-Error "Cannot connect to Photoshop. Make sure it is installed."
    exit 1
}
...
if ($result -like "ERROR:*") {
    ...
    Write-Host "  powershell -ExecutionPolicy Bypass -File `"G:\list-layers.ps1`" `"$PsdPath`"" -ForegroundColor Cyan
} else {
