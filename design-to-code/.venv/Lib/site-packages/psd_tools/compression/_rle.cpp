...
#define __pyx_kp_u_Indirect_dimensions_not_supporte __pyx_string_tab[10]
#define __pyx_kp_u_Invalid_RLE_compression __pyx_string_tab[11]
...
#define __pyx_kp_u_Unable_to_convert_item_to_object __pyx_string_tab[17]
...
#define __pyx_kp_u_bytes_but_decoded __pyx_string_tab[27]
...
#define __pyx_n_u_psd_tools_compression__rle __pyx_string_tab[86]
...
#define __pyx_n_u_pyx_unpickle_Enum __pyx_string_tab[90]
...
#define __pyx_n_u_register __pyx_string_tab[96]
...
#define __pyx_n_u_stop __pyx_string_tab[105]
#define __pyx_n_u_struct __pyx_string_tab[106]
...
#define __pyx_n_b_O __pyx_string_tab[112]
...
static PyObject *__pyx_pf_9psd_tools_11compression_4_rle_decode(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, Py_ssize_t __pyx_v_size) {
  ...
  /* "psd_tools/compression/_rle.pyx":13
 *     """
 * 
 *     cdef int i = 0             # <<<<<<<<<<<<<<
 *     cdef int j = 0
...
*/
  ...
  /* "psd_tools/compression/_rle.pyx":14
 * 
 *     cdef int i = 0
 *     cdef int j = 0             # <<<<<<<<<<<<<<
 *     cdef int length = data.shape[0]
...
*/
  ...
  /* "psd_tools/compression/_rle.pyx":15
 *     cdef int i = 0
 *     cdef int j = 0
 *     cdef int length = data.shape[0]             # <<<<<<<<<<<<<<
 *     cdef unsigned char bit
...
*/
    ...
    __pyx_t_1 = ((*((unsigned char const  *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_2 * __pyx_v_data.strides[0]) ))) != 0x80);
    if (unlikely(__pyx_t_1)) {

      /* "psd_tools/compression/_rle.pyx":21
 *     if length == 1:
 *         if data[0] != 128:
 *             raise ValueError('Invalid RLE compression')             # <<<<<<<<<<<<<<
 *         return result
...
*/
      ...
      __pyx_t_6 = 1;
      {
        PyObject *__pyx_callargs[2] = {__pyx_t_5, __pyx_mstate_global->__pyx_kp_u_Invalid_RLE_compression};
...
*/
    ...
    /* "psd_tools/compression/_rle.pyx":22
 *         if data[0] != 128:
 *             raise ValueError('Invalid RLE compression')
 *         return result             # <<<<<<<<<<<<<<
 * 
...
*/
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_4 = __pyx_convert_PyBytes_string_to_py_6libcpp_6string_std__in_string(__pyx_v_result); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_r = __pyx_t_4;
    __pyx_t_4 = 0;
    goto __pyx_L0;
...
*/
  ...
  /* "psd_tools/compression/_rle.pyx":24
 *         return result
 * 
 *     result.resize(size)             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "psd_tools/compression/_rle.pyx":26
 *     result.resize(size)
 * 
 *     while i < length:             # <<<<<<<<<<<<<<
 *         i, bit = i+1, data[i]
...
*/
    ...
    __pyx_t_8 = (*((unsigned char const  *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_2 * __pyx_v_data.strides[0]) )));
    __pyx_v_i = __pyx_t_7;
    __pyx_v_bit = __pyx_t_8;

    /* "psd_tools/compression/_rle.pyx":28
 *     while i < length:
 *         i, bit = i+1, data[i]
 *         if bit > 128:             # <<<<<<<<<<<<<<
 *             bit = 256 - bit
...
*/
      ...
      /* "psd_tools/compression/_rle.pyx":30
 *         if bit > 128:
 *             bit = 256 - bit
 *             if j+1+bit > size:             # <<<<<<<<<<<<<<
 *                 raise ValueError('Invalid RLE compression')
...
*/
      __pyx_t_1 = (((__pyx_v_j + 1) + __pyx_v_bit) > __pyx_v_size);
      if (unlikely(__pyx_t_1)) {
...
*/
      ...
      try {
        std::fill_n<std::string::iterator,long,char>((__pyx_v_result.begin() + __pyx_v_j), (1 + __pyx_v_bit), ((char)(*((unsigned char const  *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_2 * __pyx_v_data.strides[0]) )))));
      } catch(...) {
        __Pyx_CppExn2PyErr();
        __PYX_ERR(0, 32, __pyx_L1_error)
      }
 ...
 *         elif bit < 128:
*/
      __pyx_v_j = (__pyx_v_j + (1 + __pyx_v_bit));
...
*/
      __pyx_t_9 = (((__pyx_v_i + 1) + __pyx_v_bit) > __pyx_v_length);
      if (!__pyx_t_9) {
      } else {
        __pyx_t_1 = __pyx_t_9;
        goto __pyx_L10_bool_binop_done;
      }
      __pyx_t_9 = (((__pyx_v_j + 1) + __pyx_v_bit) > __pyx_v_size);
      __pyx_t_1 = __pyx_t_9;
...
*/
      ...
      try {
        std::copy_n<unsigned char const *,long,std::string::iterator>((&(*((unsigned char const  *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_2 * __pyx_v_data.strides[0]) )))), (1 + __pyx_v_bit), (__pyx_v_result.begin() + __pyx_v_j));
      } catch(...) {
        __Pyx_CppExn2PyErr();
        __PYX_ERR(0, 38, __pyx_L1_error)
      }
 ...
 *     if size and (j != size):
*/
      __pyx_v_i = (__pyx_v_i + (1 + __pyx_v_bit));
...
*/
  ...
  __pyx_t_9 = (__pyx_v_j != __pyx_v_size);
  __pyx_t_1 = __pyx_t_9;
...
*/
    __pyx_t_5 = NULL;
    __pyx_t_10 = __Pyx_PyUnicode_From_Py_ssize_t(__pyx_v_size, 0, ' ', 'd'); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __pyx_t_11 = __Pyx_PyUnicode_From_int(__pyx_v_j, 0, ' ', 'd'); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_11);
    __pyx_t_12[0] = __pyx_mstate_global->__pyx_kp_u_Expected;
    __pyx_t_12[1] = __pyx_t_10;
    __pyx_t_12[2] = __pyx_mstate_global->__pyx_kp_u_bytes_but_decoded;
    __pyx_t_12[3] = __pyx_t_11;
    __pyx_t_12[4] = __pyx_mstate_global->__pyx_kp_u_bytes;
    __pyx_t_13 = __Pyx_PyUnicode_Join(__pyx_t_12, 5, 9 + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_10) + 19 + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_11) + 6, 127);
...
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_4 = __pyx_convert_PyBytes_string_to_py_6libcpp_6string_std__in_string(__pyx_v_result); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_r = __pyx_t_4;
  __pyx_t_4 = 0;
  goto __pyx_L0;
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "encode", 0) < (0)) __PYX_ERR(0, 48, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("encode", 1, 1, 1, i); __PYX_ERR(0, 48, __pyx_L3_error) }
      }
    } else if (unlikely(__pyx_nargs != 1)) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_ds_unsigned_char__const__(values[0], 0); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 48, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("encode", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 48, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
...
*/
  ...
  /* "psd_tools/compression/_rle.pyx":55
 * 
 *     cdef unsigned char MAX_LEN = 0xFF >> 1
 *     cdef int length = data.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int i = 0
...
*/
  ...
  /* "psd_tools/compression/_rle.pyx":56
 *     cdef unsigned char MAX_LEN = 0xFF >> 1
 *     cdef int length = data.shape[0]
 *     cdef int i = 0             # <<<<<<<<<<<<<<
 *     cdef int j = 0
...
*/
  ...
  /* "psd_tools/compression/_rle.pyx":57
 *     cdef int length = data.shape[0]
 *     cdef int i = 0
 *     cdef int j = 0             # <<<<<<<<<<<<<<
 *     cdef string result
...
*/
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_data, 1, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char__const__, (int (*)(char *, PyObject *)) NULL, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 61, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_r = __pyx_t_2;
    __pyx_t_2 = 0;
    goto __pyx_L0;
...
*/
    ...
    /* "psd_tools/compression/_rle.pyx":64
 *     if length == 1:
 *         result.push_back(0)
 *         result.push_back(data[0])             # <<<<<<<<<<<<<<
 *         return result
...
*/
    ...
    /* "psd_tools/compression/_rle.pyx":65
 *         result.push_back(0)
 *         result.push_back(data[0])
 *         return result             # <<<<<<<<<<<<<<
 * 
...
*/
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_2 = __pyx_convert_PyBytes_string_to_py_6libcpp_6string_std__in_string(__pyx_v_result); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 65, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_r = __pyx_t_2;
    __pyx_t_2 = 0;
    goto __pyx_L0;
...
*/
        ...
        /* "psd_tools/compression/_rle.pyx":72
 *                 if j - i >= MAX_LEN:
 *                     break
 *                 if j + 1 >= length or data[j] != data[j+1]:             # <<<<<<<<<<<<<<
 *                     break
...
*/
        ...
        /* "psd_tools/compression/_rle.pyx":90
...
*/
        ...
        if (__pyx_t_1) {
          ...
          /* "psd_tools/compression/_rle.pyx":91
 *                 # +6  A  B  C  D  D  E  F -5  G +4  H  I  J  J  K
 *                 elif ((j+2 == length) or (MAX_LEN - (j - i) <= 2)) and not (j+1 == length) and (data[j] == data[j+1]):
 *                     break             # <<<<<<<<<<<<<<
 *                 elif j+2 < length and (data[j] == data[j+1] == data[j+2]):
...
*/
        ...
        /* "psd_tools/compression/_rle.pyx":92
 *                 elif ((j+2 == length) or (MAX_LEN - (j - i) <= 2)) and not (j+1 == length) and (data[j] == data[j+1]):
 *                     break
 *                 elif j+2 < length and (data[j] == data[j+1] == data[j+2]):             # <<<<<<<<<<<<<<
 *                     break
...
*/
        ...
        if (__pyx_t_1) {
          ...
          /* "psd_tools/compression/_rle.pyx":93
 *                     break
 *                 elif j+2 < length and (data[j] == data[j+1] == data[j+2]):
 *                     break             # <<<<<<<<<<<<<<
 *                 j += 1
...
*/
        ...
        /* "psd_tools/compression/_rle.pyx":94
 *                 elif j+2 < length and (data[j] == data[j+1] == data[j+2]):
 *                     break
 *                 j += 1             # <<<<<<<<<<<<<<
 *             result.push_back(j - i - 1)
...
*/
      ...
      /* "psd_tools/compression/_rle.pyx":95
 *                     break
 *                 j += 1
 *             result.push_back(j - i - 1)             # <<<<<<<<<<<<<<
 *             result.append(<char*>&data[i], j - i)
...
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = __pyx_convert_PyBytes_string_to_py_6libcpp_6string_std__in_string(__pyx_v_result); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 98, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
 ...
 * 
*/
  __pyx_t_4 = PyCFunction_NewEx(&__pyx_mdef_9psd_tools_11compression_4_rle_3encode, NULL, __pyx_mstate_global->__pyx_n_u_psd_tools_compression__rle); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_encode, __pyx_t_4) < (0)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{2},{35},{54},{37},{60},{24},{52},{26},{34},{9},{33},{23},{45},{22},{15},{179},{37},{32},{1},{1},{1},{1},{1},{8},{5},{6},{6},{19},{15},{23},{25},{7},{6},{2},{6},{35},{9},{30},{50},{8},{20},{32},{22},{30},{37},{5},{8},{20},{8},{15},{3},{15},{4},{1},{9},{17},{18},{5},{1},{4},{6},{8},{15},{6},{9},{5},{5},{6},{7},{12},{2},{10},{5},{5},{8},{8},{7},{4},{10},{4},{8},{4},{7},{3},{4},{3},{26},{14},{11},{10},{19},{14},{12},{10},{17},{13},{8},{12},{10},{12},{19},{5},{4},{5},{4},{4},{6},{8},{6},{6},{6},{1},{1}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 